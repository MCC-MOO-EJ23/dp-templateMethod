...
public class TempleteMethodMain extends TimerTask {
    ...
    private static final String[] PATHS = 
        new String[]{"META-INF/files/drugstore", "META-INF/files/grocery"};
    private static final String LOG_DIR = "META-INF/files/logs";
    private static final String PROCESS_DIR = "META-INF/files/process";
